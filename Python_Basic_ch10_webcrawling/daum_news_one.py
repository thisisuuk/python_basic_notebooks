# 파이썬 심화
# - 웹 크롤링: 웹 페이지에서 원하는 데이터를 수정
# - 모듈: Beatifulsoup4, selenium, requests
...
title = doc.select("h3.tit_view")[0].get_text()   #리스트0번 방에 .get_text(앞에 태그 제거하고 제목만 가져옴)
